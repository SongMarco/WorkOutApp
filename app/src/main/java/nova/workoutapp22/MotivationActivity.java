...
///////////////////////////////////////////////////////////////
    public void onAddImageButtonClicked(View v){
...
//////////////////////////////////////////////////////////////////
    ...
    public void onAddVidButtonClicked(View v){
        Intent intent = new Intent(Intent.ACTION_PICK);
        intent.setType(android.provider.MediaStore.Images.Media.CONTENT_TYPE);
        startActivityForResult(intent, PICK_FROM_ALBUM);
    }
    ...
    public void onVidButton1Clicked(View v){
        Intent vidIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.youtube.com/watch?v=JGwWNGJdvx8"));
